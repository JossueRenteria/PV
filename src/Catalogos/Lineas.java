...
public class Lineas extends javax.swing.JFrame {
    ...
    Conexion conexionLineas;
    /**
     * Creates new form Lineas
     */
    public Lineas() {
        initComponents();
        conexionLineas = new Conexion();
        conexionLineas.Open();
        conexionLineas.EjecutarSQL("SELECT id, nombre FROM Linea");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jToolBar1, javax.swing.GroupLayout.PREFERRED_SIZE, 419, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            .addGap(20, 20, 20)
                            .addComponent(jLabel1)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(text_patron)
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        ...
        dlg.setTitle("Insertar articulo");
        dlg.enlace = conexionLineas;
        dlg.padre = this;
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        int registroActivo = tableLineas.getSelectedRow();
        ...
        modelo = (DefaultTableModel)tableLineas.getModel();
    ...
    private void btn_okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_okActionPerformed
        ...
        String patron;
        patron = "SELECT * FROM Linea "+
                 "WHERE nombre LIKE '%"+text_patron.getText()+"%'";
        conexionLineas.EjecutarSQL(patron);
        cargarTabla();
    ...
    private void btn_primeroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_primeroActionPerformed
        ...
        int registros = 0;
        registros = tableLineas.getRowCount();
        if(registros == 0){
            JOptionPane.showMessageDialog(null, "No hay registros capturados");
            return;
        }else{
            tableLineas.changeSelection(0, 0, false, false); //se posiciona en el jtable en esa posicion
    ...
    private void btn_ultimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ultimoActionPerformed
        ...
        if(registros == 0){
            ...
            tableLineas.changeSelection((registros-1), 0, false, false);
        }
    ...
    private void btn_anteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_anteriorActionPerformed
        ...
        registros = tableLineas.getSelectedRow();
        if(registros == 0){
    ...
    private void btn_siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_siguienteActionPerformed
        ...
        registros = tableLineas.getSelectedRow();
        if(registros == (tableLineas.getRowCount()-1)){
            JOptionPane.showMessageDialog(null, "No es posible desplazarse más");
        }else{
            tableLineas.changeSelection(registros+1, 0, false, false);
        }
    ...
    public void cargarTabla(){
        tableLineas.getColumnModel().getColumn(0).setPreferredWidth(20);
        tableLineas.getColumnModel().getColumn(1).setPreferredWidth(200);
        
        DefaultTableModel gridLineas = (DefaultTableModel) tableLineas.getModel();
        gridLineas.setNumRows(0);
        
        try{
            while(conexionLineas.datos.next()){
                gridLineas.addRow(new Object[]{conexionLineas.datos.getString("id"),
                                               conexionLineas.datos.getString("nombre")});
            }
        }
